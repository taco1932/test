...
namespace VfxEditor.CutbFormat.Tmfcs {
    public class Tmfc : CutbEntry {
        ...
        public Tmfc( CutbFile file ) : base( file ) { }

        public Tmfc( CutbFile file, CutbReader reader ) : base( file, reader ) {
