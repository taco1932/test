...
namespace VfxEditor.CutbFormat.Utils {
    public class CutbWriter : ParsingWriter {
        ...
        public CutbWriter( int bodySize, int extraSize, int timelineSize ) : base() {
            BodySize = bodySize;
            ExtraSize = extraSize;
        ...
        public void WriteOffsetTimeline<T>( List<T> entries ) where T : CutbItemWithId
        {
