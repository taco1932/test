...
namespace VfxEditor.TmbFormat.Entries {
    public class C154 : TmbEntry {
        public const string MAGIC = "C154";
        ...
        private readonly ParsedInt Unk5 = new( "Unknown 5" ); //0 or 1
        ...
        public C154( TmbFile file ) : base( file ) { }

        public C154( TmbFile file, TmbReader reader ) : base( file, reader ) { }
