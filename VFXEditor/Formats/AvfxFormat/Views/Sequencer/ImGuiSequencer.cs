...
namespace VfxEditor.AvfxFormat {
    public abstract class ImGuiSequencer<T> : IUiItem where T : class, IIndexUiItem {
        ...
        public void Draw() {
            ...
            drawList.AddRectFilled( canvasPos, canvasPos + headerSize, 0xFFFF0000, 0.0f );
            ...
            drawList.AddRectFilled( canvasPos, canvasPos + canvasSize, 0xFF242424, 0.0f );

            drawList.AddRectFilled( canvasPos, new Vector2( canvasPos.X + canvasSize.X, canvasPos.Y + ItemHeight ), 0xFF3D3837, 0.0f );
            ...
            for( var i = 0; i < count; i++ ) {
                ...
                if( cursorY >= itemPosBase.Y && cursorY < itemPos.Y + ItemHeight && MovingEntry == null && cursorX > contentMin.X && cursorX < contentMin.X + canvasSize.X ) {
                    ...
                    drawList.AddRectFilled( itemPosBase + new Vector2( 0, 1 ), itemPosBase + new Vector2( LegendWidth, ItemHeight ), color, 0.0f );
                }
            ...
            for( var i = 0; i < count; i++ ) {
                ...
                drawList.AddRectFilled( itemPos, itemSize, color, 0.0f );
            }
            ...
            drawList.AddRectFilled( scrollBarA, scrollBarB, 0xFF222222, 0.0f );
