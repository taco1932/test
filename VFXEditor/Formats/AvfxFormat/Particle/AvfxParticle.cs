...
namespace VfxEditor.AvfxFormat {
    public class AvfxParticle : AvfxNodeWithData<ParticleType> {
        ...
        public readonly AvfxEnum<RotationDirectionBase> RotationDirectionBaseType = new( "Rotation Direction Base Type", "RBDT" );
        public readonly AvfxEnum<RotationOrder> RotationOrderType = new( "Rotation Compute Order Type", "RoOT" );
        public readonly AvfxEnum<CoordComputeOrder> CoordComputeOrderType = new( "Coordinate Compute Order Type", "CCOT" );
        public readonly AvfxEnum<DrawMode> DrawModeType = new( "Render Mode Type (Draw Mode)", "RMT" );
        public readonly AvfxEnum<CullingType> CullingTypeType = new( "Culling Type", "CulT" );
        public readonly AvfxEnum<EnvLight> EnvLightType = new( "Enviornmental Light Type", "EnvT" );
        public readonly AvfxEnum<DirLight> DirLightType = new( "Directional Light Type", "DirT" );
        ...
        public readonly AvfxBool IsDepthWrite = new( "Depth Write", "DsDw" ); //distance draw
        ...
        public readonly AvfxInt ApplyRateEnvironment = new( "Apply Environmental Light Rate", "EvAR" );
        public readonly AvfxInt ApplyRateDirectional = new( "Apply Directional Light Rate", "DlAR" );
        public readonly AvfxInt ApplyRateLightBuffer = new( "Apply Light Buffer Rate", "LBAR" );
