...
namespace VfxEditor.AvfxFormat {
    public class AvfxParticleSimple : AvfxParticleAttribute {
        ...
        public readonly AvfxFloat CoordAccuracyX = new( "Coordinate Accuracy X", "CAX" );
        public readonly AvfxFloat CoordAccuracyY = new( "Coordinate Accuracy Y", "CAY" );
        public readonly AvfxFloat CoordAccuracyZ = new( "Coordinate Accuracy Z", "CAZ" );
        public readonly AvfxFloat CoordGraX = new( "Coordinate Gravity X", "CGX" );
        public readonly AvfxFloat CoordGraY = new( "Coordinate Gravity Y", "CGY" );
        public readonly AvfxFloat CoordGraZ = new( "Coordinate Gravity Z", "CGZ" );
